...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h3 class="mb-0">Tambah Jenis Pelanggaran</h3>
            </div>
            <div class="col-sm-6">
...
<div class="app-content">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('master-data.pelanggaran.store') }}">
                    @csrf
        ...
        @endforeach
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" 
                               ...
                               placeholder="Contoh: Terlambat masuk, Membuang sampah sembarangan"
                               required>
                    ...
                    <div class="mb-3">
                        ...
                        @error('point')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small class="text-muted">Nilai poin antara 0 - 100</small>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                                  ...
                                  name="deskripsi" 
                                  rows="3"
                                  placeholder="Masukkan deskripsi pelanggaran (opsional)">{{ old('deskripsi') }}</textarea>
                        @error('deskripsi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="alert alert-info">
                        ...
                        <strong>Info:</strong> Poin akan digunakan untuk menghitung total poin pelanggaran siswa.
                    </div>
